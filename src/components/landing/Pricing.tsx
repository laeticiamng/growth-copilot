...
// Total employees in departments = 5+4+3+3+4+5+4+3+3+2+1 = 37
// Plus 2 Direction (CGO + QCO) = 39 total AI workforce
...
// Calculate totals - 37 employees across 11 departments + 2 Direction (CGO + QCO) = 39 total
const DEPT_EMPLOYEES = SERVICE_MODULES.reduce((sum, s) => sum + s.employees, 0); // = 37
