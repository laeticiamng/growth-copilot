...
function getDeadlineBadge(daysLeft: number) {
  if (daysLeft > 180) return <Badge variant="success" className="text-[10px]"><Clock className="h-2.5 w-2.5 mr-1" />Permanent</Badge>;
  ...
  return <Badge variant="error" className="text-[10px]"><AlertTriangle className="h-2.5 w-2.5 mr-1" />{daysLeft}j — Urgent</Badge>;
}
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    ...
                    <span className="flex items-center gap-1 text-xs text-muted-foreground">
                      <CheckCircle2 className="h-3 w-3" /> Éligibilité {sub.eligibility}%
                    </span>
                  </div>
                ...
                <Button variant="outline" size="sm" className="shrink-0">
                  <ExternalLink className="h-3.5 w-3.5 mr-1" /> Postuler
                </Button>
              </div>
            </CardContent>
          </Card>
